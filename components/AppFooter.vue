  ...
  <footer class="bg-black border-t border-gray-800 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a href="https://linkedin.com/in/philipppollmann" target="_blank" rel="noopener noreferrer"
                 class="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <li>
              <a href="mailto:contact@philipppollmann.de"
                 class="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
      ...
      <div class="mt-10 pt-6 border-t border-gray-800 text-center text-gray-500 text-sm">
        <p>&copy; {{ new Date().getFullYear() }} Philipp Pollmann. Alle Rechte vorbehalten.</p>
      </div>
    </div>
  </footer>
</template>
...
h3::after {
  ...
  width: 32px;
  height: 2px;
  background: linear-gradient(to right, var(--primary, #e20074), transparent);
}
</style>