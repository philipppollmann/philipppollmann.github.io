<template>
  <div class="relative">
    <div class="ml-24">
      <h1 class="text-gray-400 mt-2 uppercase tracking-widest text-xl font-bold">FRONTEND</h1>
      <hr class="w-1/6 ">
      <table class="w-full border-collapse ml-40">
        ...
        <tr>
          ...
          <td class="border-l px-4 py-2 float-left w-auto">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/HTML5_Badge.svg/2048px-HTML5_Badge.svg.png" alt="HTMLLogo" class="w-32">
            <p>HTML</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="border-r px-4 py-2 w-5">
          </td>
          <td class="border-b px-4 py-2 float-lef w-5">
          </td>
        </tr>
        </tbody>
      </table>
    ...
    <div class="ml-24">
      ...
      <table class="w-full border-collapse ml-40">
        ...
        <tr>
          ...
          <td class="border-l px-4 py-2 float-left w-auto">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Microsoft_Azure.svg/2048px-Microsoft_Azure.svg.png" alt="AzureLogo" class="w-32">
            <p>Microsoft Azure</p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="border-t border-r px-4 py-2 w-5">
          </td>
          <td class="px-4 py-2 float-lef w-5">
          </td>
        </tr>
        </tbody>
      </table>
    ...
    <div class="ml-24">
      <h1 class="text-gray-400 mt-2 uppercase tracking-widest text-xl font-bold">REPORTING</h1>
      <hr class="w-1/6 mb-5">
      <table class="w-full border-collapse ml-40">
        <thead>
        <tr></tr>
    ...
    <div class="ml-24">
      <h1 class="text-gray-400 mt-2 uppercase tracking-widest text-xl font-bold">CERTIFICATIONS</h1>
      <hr class="w-1/6 mb-5">
      ...
      <table class="w-full border-collapse ml-40">
        ...
        <tr>
          ...
          <td class="border-l border-b px-4 py-2 float-left w-auto">
            <img src="../assets/img/aws-certified-cloud-practitioner.png" alt="AWSCloudPractitioner" class="w-32">
